...
export default function OnboardingPortal({
  ...
  const sendDataToPostman = async () => {
    ...
    const apiurl = process.env.REACT_APP_POST_API_URL
  ...
  return (
    <Card className="w-[400px] mx-auto my-10 bg-gray-300 ">
      <CardHeader>
        <CardTitle className="text-2xl mb-2 bg-teal-800 text-white p-2 rounded-md">
          Onboarding Portal
        </CardTitle>
      </CardHeader>
      <CardContent>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <input
                    ...
                    name="publicKey"
                    value={
                      typeof formData.publicKey === "string"
                        ? formData.publicKey
                        : ""
                    }
                    onChange={handleFormChange}
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <PhoneInput
                  ...
                  onChange={(phone) =>
                    setUserClaims((prev) => ({ ...prev, phone_number: phone }))
                  }
